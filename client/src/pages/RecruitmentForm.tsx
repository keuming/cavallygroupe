...
export function RecruitmentForm() {
  ...
  const submitMutation = trpc.recruitment.submitApplication.useMutation();
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <Card className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Formulaire de Soutien Scolaire</h1>
            <p className="text-gray-600">Rejoignez notre équipe de tuteurs chez Cavally Livres</p>
          </div>
