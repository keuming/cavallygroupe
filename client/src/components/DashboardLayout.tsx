  ...
  if (!user) {
    return (
      <div className={`flex items-center justify-center min-h-screen transition-colors duration-300 ${
        ...
        <div className={`flex flex-col items-center gap-8 p-8 max-w-md w-full rounded-lg transition-colors duration-300 ${
          isDarkMode ? 'bg-gray-800' : 'bg-white'
        }`}>
          <div className="flex flex-col items-center gap-6">
            <h1 className={`text-2xl font-semibold tracking-tight text-center transition-colors duration-300 ${
