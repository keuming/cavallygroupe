...
export const supplyFileTypeEnum = pgEnum("supply_file_type", ["pdf", "image", "document", "text", "word", "excel"]);
export const supplyStatusEnum = pgEnum("supply_status", ["uploaded", "processing", "processed", "error", "quoted", "invoiced", "paid", "cancelled"]);
